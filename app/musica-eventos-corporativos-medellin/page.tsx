...
const cfg: ServiceConfig = {
  ...
  h1Em: "en Medellín",
  heroImg: "/Vids/posters/corporate-hero.jpg?v=2",
  heroVideo: "/Vids/bg/corporate.mp4?v=2",
  heroVideoPos: "50% 32%",
  heroPos: "50% 30%",
  ...
  momentsImg: "/Vids/posters/violin.jpg",
  ...
  gallery: [
    { src: U + "corporate-5250.webp", alt: "Meli Rox en un evento corporativo en Medellín" },
    { src: U + "IMG_5220.JPG.webp", alt: "Meli Rox violinista eléctrica en escenario con producción" },
    { src: F + "IMG_2501.webp", alt: "Meli Rox tocando violín eléctrico en vivo" },
    { src: F + "IMG_2513.webp", alt: "Meli Rox cantando en un escenario" },
  ],
  faq: [
