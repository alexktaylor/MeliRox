...
const cfg: ServiceConfig = {
  ...
  gallery: [
    { src: F + "IMG_6812.webp", alt: "Meli Rox en un evento privado en Medellín" },
    { src: F + "DVR_0449.webp", alt: "Meli Rox — sesión íntima con violín" },
    { src: F + "DSC08345.webp", alt: "Retrato de Meli Rox violinista eléctrica" },
