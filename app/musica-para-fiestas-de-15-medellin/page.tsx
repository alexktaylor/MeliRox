...
const cfg: ServiceConfig = {
  ...
  gallery: [
    ...
    { src: F + "DVR_0507.webp", alt: "Meli Rox con violín eléctrico" },
    { src: F + "wedding1.webp", alt: "Meli Rox violinista para celebraciones" },
    { src: F + "DSC08571.webp", alt: "Meli Rox en una fiesta de 15 en Medellín" },
  ],
  faq: [
