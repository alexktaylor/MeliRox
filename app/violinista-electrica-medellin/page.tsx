...
const cfg: ServiceConfig = {
  ...
  gallery: [
    { src: F + "IMG_2471.webp", alt: "Meli Rox violinista eléctrica en un festival" },
    { src: F + "IMG_2501.webp", alt: "Meli Rox tocando violín eléctrico en concierto" },
    { src: F + "DSC08415.webp", alt: "Meli Rox en escena con violín eléctrico" },
