...
const cfg: ServiceConfig = {
  ...
  gallery: [
    { src: F + "Meli%20Rox%20wedding.webp", alt: "Meli Rox tocando violín en una boda en Medellín" },
    { src: F + "wedding1.webp", alt: "Violinista en vivo durante una ceremonia de boda" },
    { src: F + "IMG_1922.webp", alt: "Meli Rox — música en vivo para boda" },
    { src: F + "Meli%20violin%20(1).webp", alt: "Meli Rox con violín eléctrico" },
  ],
  faq: [
  ...
  ctaImg: F + "Meli%20Rox%20wedding.webp",
